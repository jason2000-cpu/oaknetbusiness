...
$query = "SELECT account_balance FROM accounts WHERE account_name = '{$username}'";
...
$account_bal_after_withdraw = $accountBalance + $amount;
...
if ($accountBalance === 0) {
    ...
    $arr = [
        ":owner" => $accountOwner,
        ":amount" => $account_bal_after_withdraw,
    ];
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="me-breadcrumb-box">
                            <h1>withdraw</h1>
                            <p><a href="<?php echo APPURL ?>/home.php">Home</a>withdraw</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="me-my-profile-body">
                                <div class="me-account-summary">
                                    <div class="me-account-summary-head">
                                        <div>
                                            <h4>Dear <?php echo $username;?> your Withdraw request to withdraw KSH
                                                <?php echo $amount ?> was succesful.Continue Enjoying our services</h4>
                                        </div>
                                    </div>
