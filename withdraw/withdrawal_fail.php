                ...
                <div class="row">
                    <div class="col-12">
                        <div class="me-breadcrumb-box">
                            <h1>Withdraw Fail</h1>
                            <p><a href="<?php echo APPURL ?>/home.php">Home</a>Withdraw Fail</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="me-my-profile-body">
                                <div class="me-account-summary">
                                    <div class="me-account-summary-head">
                                        <div>
                                            <h4><?php echo $username ?>Your withdraw request of <?php echo $amount?> was
                                                not succesiful check you account balance
                                                before you withdraw</h4>
                                        </div>
                                    </div>
