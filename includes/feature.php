        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="me-feature-box">
                    ...
                    <p>Assisting clients in buying and selling stocks for long-term growth.</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.038 424.038">
                        ...
                        <path
                            d="M418,377.219h-29.6v-185.2c0-3.6-2.8-6.4-6.4-6.4h-58.8c-3.6,0-6.4,2.8-6.4,6.4v185.2h-21.6v-121.2c0-3.6-2.8-6.4-6.4-6.4
            ...
            <div class="col-lg-3 col-md-6">
                <div class="me-feature-box">
                    ...
                    <p>Facilitating trading of valuable resources for diversification and potential profits.</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.038 424.038">
                        <path d="M352.4,34.019c-32.4,0-58,26-58,58.4c0,32.4,26,58,58,58s58.4-26,58.4-58.4C410.8,59.619,384.8,34.019,352.4,34.019z
                                 M352.4,137.619c-25.2,0-45.6-20.4-45.6-45.6s20.8-45.2,45.6-45.2c25.2,0,45.6,20.4,45.6,45.6
                                C398,117.619,377.6,137.619,352.4,137.619z" />
            ...
            <div class="col-lg-3 col-md-6">
                <div class="me-feature-box">
                    ...
                    <p>Offering stable income options through government bonds and corporate securities.</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.038 424.038">
                        <path d="M352.4,34.019c-32.4,0-58,26-58,58.4c0,32.4,26,58,58,58s58.4-26,58.4-58.4C410.8,59.619,384.8,34.019,352.4,34.019z
                                 M352.4,137.619c-25.2,0-45.6-20.4-45.6-45.6s20.8-45.2,45.6-45.2c25.2,0,45.6,20.4,45.6,45.6
                                C398,117.619,377.6,137.619,352.4,137.619z" />
            ...
            <div class="col-lg-3 col-md-6">
                <div class="me-feature-box">
                    ...
                    <p>Providing expert guidance and tailored investment strategies for financial success.</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.038 424.038">
                        <path d="M352.4,34.019c-32.4,0-58,26-58,58.4c0,32.4,26,58,58,58s58.4-26,58.4-58.4C410.8,59.619,384.8,34.019,352.4,34.019z
                                 M352.4,137.619c-25.2,0-45.6-20.4-45.6-45.6s20.8-45.2,45.6-45.2c25.2,0,45.6,20.4,45.6,45.6
                                C398,117.619,377.6,137.619,352.4,137.619z" />
