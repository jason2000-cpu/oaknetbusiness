...
$new_balance = $transactionAmount + $balance;
...
// Subscription duration (you can change this value to 'monthly', 'half-year', or 'one-year')
...
if ($subscriptionDuration === "monthly") {
    ...
    $subscriptionEndDate = date("Y-m-d", strtotime("+1 month", strtotime($subscriptionStartDate)));
} elseif ($subscriptionDuration === "halfyear") {
    // Half-Year Subscription (6 months from the start date)
    $subscriptionEndDate = date("Y-m-d", strtotime("+6 months", strtotime($subscriptionStartDate)));
} elseif ($subscriptionDuration === "year") {
    // One-Year Subscription (1 year from the start date)
    $subscriptionEndDate = date("Y-m-d", strtotime("+1 year", strtotime($subscriptionStartDate)));
} else {
...
$query="INSERT INTO subscription(subscription_name,subscription_amount,subscription_duration,username,subscription_end,subscription_start)VALUES(:name,:amount,:duration,:username,:end,:start)";
$arr=[
    ":amount"=>$amount,
    ":name"=>$package,
    ":duration"=>$period,
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="me-breadcrumb-box">
                            <h1>Pay Successful</h1>
                            <p><a href="<?php echo APPURL ?>/home.php">Home</a>Payment</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="me-my-profile-body">
                                <div class="me-account-summary">
                                    <div class="me-account-summary-head">
                                        <div>
                                            <h4>Thank you We have recieved you payment</h4>
                                        </div>
                                    </div>
                                    <div class="me-account-summary-body me-account-money-detail">
                                        <ul>
                                            ...
                                            <a href="../home.php" class="me-btn">Go
                                                back</a>
                                            </li>
