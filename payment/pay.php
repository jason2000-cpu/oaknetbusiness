...
// Check if the package name exists inthe users subscriptions
$app=new App;
$query="SELECT * FROM subscription WHERE username='{$username}' AND subscription_name='{$package}'";
                        ...
                        <div class="me-my-account-profile">
                            <div class="me-my-profile-head">
                                <div class="me-profile-name">
                                    <h4>Your are already subscribed</h4>
                                </div>
                            ...
                            <div class="me-my-profile-body">
                                <div class="me-account-summary">
                                    <div class="me-account-summary-head">
                                        <div>
                                            <h4>already subscribed to this plan</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="me-account-summary-body me-account-money-detail">
                                        <ul>
                                            <form action="" method="post">
                                                ...
                                                <button class="me-btn"
                                                    style="background-color: #90C641 !important; color:white !important;">Pay
                                                    with Mpesa</button>
                                                </li>
                                                        ...
                                                        paypal.Buttons({
                                                            ...
                                                            createOrder: (data, actions) => {
                                                                return actions.order.create({
                                                                    purchase_units: [{
                                                                        amount: {
                                                                            value: '<?php echo $selectedPackage['amount'] ?>' // Can also reference a variable or function
                                                                        }
                                                                    }]
                                                                });
                                                            },
