...
<body>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-xxl-12 col-md-12 col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive" id="displaysubscriptionsTable">
    ...
    ***********************************-->
            ...
            function displayData() {
                ...
                $.ajax({
                    url: "ajax/displaysubscriptions.php",
                    type: 'POST',
                    data: {
                    ...
                    success: function(data, status) {
                        ...
                        $('#displaysubscriptionsTable').html(data);
                    },
                });
            }

            function deleteSubscription(deleteid) {
                $.ajax({
                    url: "ajax/delete_subscription.php",
                    type: "POST",
                    data: {
                        deletesend: deleteid
                    },
